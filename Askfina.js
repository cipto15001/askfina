function Qismo(appID, options){
    ...
    function attachQismoCustomCSS(style) {
        ...
        if(!qismoConfig.buttonHasIcon) cssstring += '.AskFina img { display:none;}';
    ...
    self.renderQismoTriggerButton = function() {
        var buttonText = (qismoConfig.buttonHasText)
            ...
            button = self.createNode('div', null, {
                'class': 'AskFina qcw-cs-trigger-button'
            });
    ...
    function attachEventListenerChat(){
        var targetClass = ['AskFina','qcw-cs-trigger-button','qcw-cs-close', 'qcw-cs-close-welcome','qcw-window-toggle-btn'];
            ...
            document.addEventListener('click', function(e) {
                ...
                if(filterClass(e)) {
                    ...
                    if (self.$('.qcw-cs-container--open') || self.$('.qcw-container--open')) {
                        ...
                        if(qismoConfig.buttonIcon) self.$('.AskFina img').src=qismoConfig.buttonIcon;
                        ...
                        if(qismoConfig.buttonIcon) self.$('.AskFina img').src=closeIcon;
    ...
    document.addEventListener('click', function (e) {
        if(e.target && (e.target.classList.contains('AskFina') || e.target.parentNode.classList.contains('AskFina'))) {
...
Qismo.prototype.attachLoginFormToDOM = function() {
    ...
    self.addEvent(self.$('.qcw-cs-wrapper form'), 'submit', function (e) {
        ...
        var _self = self.$('.qcw-cs-wrapper form'),
            ...
            randomKey = Date.now(),
            userData = {
                user_id: self.$('#inputEmail').value.toLowerCase(),
        ...
        if(!self.ValidateEmail()) return false;
